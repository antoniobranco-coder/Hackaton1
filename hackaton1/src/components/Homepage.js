				...
				<div>
					...
					<div className="welcome-title">
						<div className="welcome-text">
							Do you want to virtually travel the world or see if a specific place is crowded ? Take a
							look and explore the world from your couch!
						</div>
					</div>
					<div>
						<Filters
							...
							listCountries={this.state.getDataCountries.sort()}
							selectedCategory={this.state.selectedCategory}
							handleChangeCategory={this.handleChangeCategory}
							listCategories={this.state.getDataCategories.sort()}
						/>
					</div>
					<div>
						<img className="photo" src="https://imgur.com/Ve7LdMa.png" alt="photo" />
						<img className="photo" src="https://imgur.com/wOn2YH9.png" alt="photo" />
						<img className="photo" src="https://imgur.com/2E1CP3O.png" alt="photo" />
						<img className="photo" src="https://imgur.com/giLVnqI.png" alt="photo" />
					</div>
					<div>
						<WebcamList
							selectedCategory={this.state.selectedCategory}
