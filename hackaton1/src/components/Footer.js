    ...
    <Col sm={12} lg={12}>
      <footer className="containerFooter">
        <ul className="footerList">
          <a href="https://github.com/MargSousa">
            Margarida Sousa 
          </a>
          <a href="https://www.https://github.com/Numissa11">
            Aline Sinclaire
          </a>
        ...
        <ul className="footerList3">
          ...
          <img style = {{marginLeft : "8px", marginTop : "15px", marginBottom : "13px"}} className="tw" src={twitter} alt="twitter logo" />
